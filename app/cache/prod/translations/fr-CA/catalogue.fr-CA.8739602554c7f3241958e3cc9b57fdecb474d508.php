...
$catalogue = new MessageCatalogue('fr-CA', array (
  ...
  array (
    ...
    'Impossible to send the email!' => 'Impossible d\'envoyer le courriel!',
    'Cannot create settings file, if /app/config/parameters.php exists, please give the public write permissions to this file, else please create a file named parameters.php in config directory.' => 'Impossible de créer le fichier "settings". Si /app/config/parameters.php existe, veuillez donner les droits public en écriture à ce fichier. Sinon, créez ce fichier dans votre répertoire "config".',
    ...
    'An error occurred while sending email, please verify your parameters.' => 'Une erreur est survenue lors de l\'envoi du courriel, merci de vérifier vos paramètres.',
...
[1]Pour les services :[/1] J\'accepte le lancement de la prestation de service et je reconnais perdre mon droit de révocation dès que la prestation est entièrement exécutée.',
  ...
  array (
    ...
    'These are all the modules you’ve added to your shop, either by buying it from PrestaShop Addons, or by uploading it directly.' => 'Vous trouverez ici tous les modules que vous avez ajoutés à votre boutique, soit en les achetant sur notre marketplace PrestaShop Addons, soit en les chargeant directement.',
  ...
  array (
    ...
    'An error occurred while attempting to associate this image with your shop. ' => 'Une erreur s\'est produite lors de la tentative d\'association de cette image à votre boutique. ',
  ...
  array (
    ...
    'If your backup file exceeds this limit, contact your hosting provider for assistance. ' => 'Si le poids de votre fichier de sauvegarde est trop large, contactez votre hébergeur. ',
  ...
  array (
    ...
    'Credit card multiple' => 'Carte de crédit en plusieurs fois',
    'Prepaid account (MoneyBookers, PayPal...)' => 'Compte prépayé (MoneyBookers, PayPal, etc.)',
    'Please accept the terms of service.' => 'Merci d\'accepter les termes du service.',
    ...
    'I agree with the terms of PrestaShop Security service and I adhere to them unconditionally.' => 'Je suis d\'accord avec les conditions de service PrestaShop Security et y adhére sans condition.',
    ...
    'Pick up in-store' => 'Ramasser en magasin',
    'Withdrawal point' => 'Point de retrait, point relais',
    ...
    'boost your conversions' => 'renforcer votre taux de conversion',
    'increase your clients\' average cart' => 'augmenter le panier moyen de vos clients',
    'Selection of modules recommended for' => 'Sélection de modules recommandés pour',
  ...
  array (
    ...
    'Error: invalid e-mail template' => 'Erreur : template courriel non valable',
    'Error: invalid e-mail subject' => 'Erreur : sujet de courriel non valable',
    'Error: invalid e-mail address' => 'Erreur : adresse courriel non valable',
  ...
  array (
    ...
    'Send an email with summary of the account information (email, password) after registration.' => 'Envoyer un courriel avec le récapitulatif des informations de connexion (courriel et mot de passe) après la création du compte.',
  ...
  array (
    ...
    'This email address is not valid' => 'Cette adresse courriel n\'est pas valide',
  ...
  array (
    ...
    'Editing this product line will remove the reduction and base price.' => 'Modifier cette ligne du produit supprimera la réduction et le prix de base.',
